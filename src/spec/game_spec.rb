...
describe Game do
  before :each do
    @game = Game.new('2000/04/04', false, '2021/04/04', archived: false, id: rand(1..1000))
    @game1 = Game.new('1999/01/01', false, '2000/01/01')
    @game3 = Game.new('2015/01/01', true, '2018/01/01')
  end
